...
def init():
    con = None
    try:
        con = mysql.connector.connect(host='db4free.net', user='root_sergi', password='Root123!')
        cur = con.cursor()
...
def addUser(user):
    con = mysql.connector.connect(host='db4free.net', user='root_sergi', password='Root123!', database='paqui_bd')
